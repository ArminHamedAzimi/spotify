...
CHANNEL_LAYERS = {
    "default": {
        ...
        "CONFIG": {
            "hosts": [os.getenv("CHAT_REDIS_URL", "redis://localhost:6379/0")],
        },
    },
}
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("POSTGRES_DB", "spotify"),
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Authenticated CRUD API for users, songs, playlists, and follows.",
    "VERSION": "1.0.0",
}
